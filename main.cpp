...
void myGlutDisplay( void )
{
   ...
   glVertex3f(DataPoint[0],DataPoint[1]-.05,DataPoint[2]);
   glVertex3f(DataPoint[0],DataPoint[1]+.05,DataPoint[2]);
   glEnd(); 
   glBegin(GL_LINES);
   glColor3f( 0.5, 0.5, 0.5 );
   glVertex3f(DataPoint[0]-.05,DataPoint[1],DataPoint[2]);
   glVertex3f(DataPoint[0]+.05,DataPoint[1],DataPoint[2]);
   glEnd(); */
...
int main(int argc, char* argv[])
{
  ...
  GLUI_Spinner *segment_spinner_red = 
    glui->add_spinner( "Red:", GLUI_SPINNER_INT, &globalRed );
  segment_spinner_red->set_int_limits( 0, 255 ); 
  segment_spinner_red->set_speed( 0.1 ); 
  
  GLUI_Spinner *segment_spinner_green = 
    glui->add_spinner( "Green:", GLUI_SPINNER_INT, &globalGreen );
  segment_spinner_green->set_int_limits( 0, 255 ); 
  segment_spinner_green->set_speed( 0.1 ); 
  
  GLUI_Spinner *segment_spinner_blue = 
    glui->add_spinner( "Blue:", GLUI_SPINNER_INT, &globalBlue );
