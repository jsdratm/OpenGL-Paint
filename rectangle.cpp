...
rectangle::rectangle(point startPoint, point endPoint, GLdouble red, GLdouble green, GLdouble blue):startPoint(startPoint),endPoint(endPoint),red(red),green(green),blue(blue){
